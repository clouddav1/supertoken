...
var require_session_shared3 = __commonJS({
  "node_modules/supertokens-auth-react/lib/build/session-shared3.js"(exports) {
    "use strict";
    var genericComponentOverrideContext = require_genericComponentOverrideContext();
    ...
    var PrimitiveArrayClaim = function(_super) {
    ...
    var PrimitiveClaim = function(_super) {
    ...
    var SessionAPIWrapper = function() {
      ...
      SessionAPIWrapper2.attemptRefreshingSession = function() {
        return genericComponentOverrideContext.__awaiter(this, void 0, void 0, function() {
          return genericComponentOverrideContext.__generator(this, function(_a) {
            return [2, recipe.Session.getInstanceOrThrow().attemptRefreshingSession()];
          });
        });
      };
      ...
      SessionAPIWrapper2.useSessionContext = useSessionContext$1;
...
//# sourceMappingURL=chunk-VB6G4HUZ.js.map
