  ...
  "node_modules/supertokens-auth-react/lib/build/index2.js"(exports) {
    ...
    var RecipeRouter = function() {
      ...
      RecipeRouter2.getMatchingComponentForRouteAndRecipeIdFromPreBuiltUIList = function(normalisedUrl, preBuiltUIList, defaultToStaticList, dynamicLoginMethods) {
        ...
        if (componentMatchingRid && (!priorityOrder.map(function(a) {
          return a.rid;
        }).includes(componentMatchingRid.recipeID) || ((_a = dynamicLoginMethods[componentMatchingRid.recipeID]) === null || _a === void 0 ? void 0 : _a.enabled) === true)) {
          return componentMatchingRid;
        }
...
//# sourceMappingURL=chunk-BFBCIXZB.js.map
